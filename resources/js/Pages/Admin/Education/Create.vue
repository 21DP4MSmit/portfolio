<template>
  <Layout>
      ...
      <h1 class="text-3xl font-extrabold mb-8 text-gray-400 border-b pb-4">Create Education Record</h1>
      ...
      <form @submit.prevent="submit" class="space-y-8">
        ...
        <div>
          ...
          <textarea v-model="form.description" rows="3" class="mt-1 block w-full rounded-md border-gray-300  bg-zinc-900 shadow-sm"></textarea>
...
const submit = () => {
  ...
  form.transform(() => formattedData).post(route('admin.education.store'))
}
