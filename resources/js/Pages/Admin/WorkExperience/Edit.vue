<template>
    <Layout>
      <div class="max-w-4xl mx-auto p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
        <h1 class="text-3xl font-extrabold mb-8 text-gray-800 border-b pb-4">Edit Work Experience</h1>
        
        <form @submit.prevent="submit" class="space-y-8">
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              <label class="block text-md font-semibold text-gray-700 mb-2">Company</label>
              <input v-model="form.company" type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300">
              <p v-if="form.errors.company" class="text-red-500 text-sm mt-2 pl-1">{{ form.errors.company }}</p>
            </div>
  
            <div>
              <label class="block text-md font-semibold text-gray-700 mb-2">Position</label>
              <input v-model="form.position" type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              <label class="block text-md font-semibold text-gray-700 mb-2">Start Date</label>
            ...
            <div>
              <label class="block text-md font-semibold text-gray-700 mb-2">End Date</label>
              <VueDatePicker 
              ...
              <div class="mt-2 flex items-center">
                ...
                <label class="ml-2 text-sm text-gray-600">Currently working here</label>
              </div>
